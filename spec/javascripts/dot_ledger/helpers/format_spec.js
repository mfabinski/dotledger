describe('DotLedger.Helpers.Format', function () {
  ...
  describe('.money', function () {
    return it('correctly formats a number to money', function () {
  ...
  return describe('.unixMilliTimestamp', function () {
    return it('correctly formats the date', function () {
      // FIXME: I hate timezones.
