describe('DotLedger.Routers.App', function () {
  ...
  describe('Root', function () {
    return it('routes to root', function () {
      var router
  ...
  describe('Accounts', function () {
    ...
    return it('routes to showAccout with a tab and page number', function () {
      var router
      router = createRouter('showAccount')
  ...
  describe('Categories', function () {
    ...
    return it('routes to editCategory', function () {
      var router
  ...
  describe('SortingRules', function () {
    ...
    return it('routes to editSortingRule', function () {
      var router
  ...
  describe('Goals', function () {
    return it('routes to listGoals', function () {
      var router
  ...
  describe('Payments', function () {
    ...
    return it('routes to editPayment', function () {
      var router
  ...
  describe('Search', function () {
    ...
    return it('routes to search with params and page number', function () {
      var router
      router = createRouter('search')
  ...
  return describe('Reports', function () {
    return it('routes to income and expenses', function () {
      var router
